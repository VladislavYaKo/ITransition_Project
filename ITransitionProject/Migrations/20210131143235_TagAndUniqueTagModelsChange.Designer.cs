...
namespace ITransitionProject.Migrations
{
    ...
    [Migration("20210131143235_TagAndUniqueTagModelsChange")]
    partial class TagAndUniqueTagModelsChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ITransitionProject.Models.AdditionalFieldsNames", b =>
                {
                    ...
                    b.Property<string>("BooleanFieldsNames")
                        .HasMaxLength(256)
            ...
            modelBuilder.Entity("ITransitionProject.Models.Tag", b =>
                {
                    ...
                    b.HasKey("ItemCollectionUserId", "ItemId", "TagValue");

                    b.HasIndex("ItemId", "ItemCollectionUserId");

                    b.ToTable("Tags");
                });

            modelBuilder.Entity("ITransitionProject.Models.UniqueTag", b =>
                {
                    b.Property<string>("TagValue")
                        .HasMaxLength(30)
                        .HasColumnType("nvarchar(30)");
            ...
            modelBuilder.Entity("ITransitionProject.Models.Tag", b =>
                {
                    b.HasOne("ITransitionProject.Models.Item", null)
                        .WithMany("Tags")
                        .HasForeignKey("ItemId", "ItemCollectionUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
