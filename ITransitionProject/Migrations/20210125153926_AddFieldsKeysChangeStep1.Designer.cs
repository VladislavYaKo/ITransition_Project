...
namespace ITransitionProject.Migrations
{
    ...
    [Migration("20210125153926_AddFieldsKeysChangeStep1")]
    partial class AddFieldsKeysChangeStep1
    {
            ...
            modelBuilder.Entity("ITransitionProject.Models.Collection", b =>
                {
                    ...
                    b.Property<Guid?>("AddFieldsNamesForChangeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AddFieldsNamesForChangeId");
            ...
            modelBuilder.Entity("ITransitionProject.Models.Item", b =>
                {
                    ...
                    b.Property<Guid?>("AddFieldsValuesForChangeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AddFieldsValuesForChangeId");
            ...
            modelBuilder.Entity("ITransitionProject.Models.Collection", b =>
                {
                    b.HasOne("ITransitionProject.Models.AdditionalFieldsNames", "AddFieldsNames")
                        .WithMany()
                        .HasForeignKey("AddFieldsNamesForChangeId");
            ...
            modelBuilder.Entity("ITransitionProject.Models.Item", b =>
                {
                    b.HasOne("ITransitionProject.Models.AdditionalFieldsValues", "AddFieldsValues")
                        .WithMany()
                        .HasForeignKey("AddFieldsValuesForChangeId");
