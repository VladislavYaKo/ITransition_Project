...
namespace ITransitionProject.Migrations
{
    ...
    [Migration("20210125154719_AddCompositeKeyToCollectionModelStep1")]
    partial class AddCompositeKeyToCollectionModelStep1
    {
            ...
            modelBuilder.Entity("ITransitionProject.Models.Item", b =>
                {
                    ...
                    b.Property<int>("CollectionForChangeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CollectionForChangeId", "CollectionUserId");
            ...
            modelBuilder.Entity("ITransitionProject.Models.Item", b =>
                {
                    ...
                    b.HasOne("ITransitionProject.Models.Collection", null)
                        .WithMany("Items")
                        .HasForeignKey("CollectionForChangeId", "CollectionUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
